<template>
  <div
          class="relative  margin-bottom-auto margin-top-auto   flex content-center items-center justify-center"
          style="min-height: 100vh;"
        >
  <div
            class="absolute top-0 w-full h-full bg-center bg-cover"
             style='background-image: url("https://images.unsplash.com/photo-1501696057772-02661ce93702?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80");'
...
<div class="items-center flex flex-wrap">
      ...
      <div class="space-y-1 my-2 text-sm">
				...
				<input type="text" name="name" id="name" placeholder="Your Name" class="w-full px-4 py-3 rounded border-coolGray-300 bg-coolGray-50 text-coolGray-800">
			</div>
      ...
      <div class="space-y-1 text-sm my-4">
		...
		<div class="flex items-center py-6 space-x-1">
			...
			<p class="px-3 text-sm text-coolGray-600">Register with social accounts</p>
			<div class="flex-1 h-px sm:w-16 bg-coolGray-300"></div>
		</div>
		<div class="flex justify-center space-x-4">
			<button  @click="socialregister()" aria-label="register with Google" class="p-3 rounded-sm">
